    ...
    <>
      <section>
        <div className="container mx-auto md:px-6 px-4">
          <div className="about-me md:grid md:grid-cols-2 mt-8">
            <div className="details">
              ...
              <p className="text-center md:text-justify">
                Welcome to my world of visual storytelling. I'm passionate about
                capturing life's most precious moments and transforming them
                into timeless memories that speak to the heart.
              </p>
          ...
          <div className="other-sub-section flex md:flex-row flex-col gap-2">
            <div className="expertise bg-white px-3 py-2 rounded-[10px]">
              <h2 className="font-bold flex items-center gap-2">
                Camera Systems <Camera size={13} />
              </h2>
              <p>Canon EOS R series, Sony FX series</p>
            </div>
            <div className="lenses bg-white px-3 py-2 rounded-[10px]">
              <h2 className="font-bold flex items-center gap-2">
                Lenses <Focus size={13} />
              </h2>
              Prime and zoom lenses covering 16mm to 200mm
            </div>
            <div className="video-equipment bg-white px-3 py-2 rounded-[10px]">
              <h2 className="font-bold flex items-center gap-2">
                Video Equipment <Clapperboard size={13} />
              </h2>
              <p> 4K recording, professional audio, stabilization</p>
            </div>
            <div className="post-production bg-white px-3 py-2 rounded-[10px]">
              <h2 className="font-bold flex items-center gap-2">
                Post-Production <Film size={13} />
              </h2>
              <p>Adobe Creative Suite mastery </p>
            </div>
          </div>
